"""Shell node — run shell commands and capture their output.
...
class ShellCombinedOutput(Data):
...
class ShellNode(Node[ShellInput, Data, ShellNodeParams]):
